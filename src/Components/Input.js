...
const Input = ({ addTask }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit}>
            ...
            <input id="input" value={userInput} type="text" onChange={handleChange} placeholder="Agregar Tarea..." className="text-2xl font-light text-center border-2 border-gray-200 rounded mr-8  mb-20 bg-white-light w-6/12 pt-1"/>
            <button className="bg-teal-darkest border-teal-darkest border-2 w-16 rounded-md text-3xl hover:shadow-md pt-1  ">+</button>
        </form>
    );
};
